...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $insert = $conn->prepare("INSERT INTO users (name, phone, email, reason, password) VALUES (?, ?, ?, ?, ?)");
        if ($insert->execute([$name, $phone, $email, $reason, $pass])) {
            echo '
                <div style="
                ...
                ">
                    ✅ রেজিস্ট্রেশন সফল হয়েছে! ৫ সেকেন্ডের মধ্যে লগইন পেজে চলে যাচ্ছেন...
                </div>
                <script>
                    setTimeout(function() {
